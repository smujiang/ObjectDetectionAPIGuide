...
flags = tf.app.flags
flags.DEFINE_string('data_dir', 'H:\Dataset\Oxford-IIITPet', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', 'H:\Dataset\Oxford-IIITPet\TFRecords', 'Path to directory to output TFRecords.')
flags.DEFINE_string('label_map_path', 'H:\Dataset\Oxford-IIITPet\labelmap\pet_label_map.pbtxt',
...
def main(_):
  ...
  image_dir = os.path.join(data_dir, 'images')  #H:\Dataset\Oxford-IIITPet\images
  annotations_dir = os.path.join(data_dir, 'annotations')  #H:\Dataset\Oxford-IIITPet\annotations
  examples_path = os.path.join(annotations_dir, 'trainval.txt') #training and validation samples
